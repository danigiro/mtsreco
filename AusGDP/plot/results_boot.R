...
ggsave(plot = figure_prob, file = paste0("AUS_Bootstrap_CRPS_ES.pdf"),
       width = 210, height = 140, units = "mm")
ggsave(plot = figure_probvs, file = paste0("AUS_Bootstrap_CRPS_VS.pdf"),
       width = 210, height = 140, units = "mm")
ggsave(plot = plot_vs, file = paste0("AUS_Bootstrap_VS.pdf"),
