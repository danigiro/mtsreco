...
ggsave(plot_es_h, filename = "EA_GAUSS_ES_h.pdf",
       width = 210,
       height = 200,
       units = "mm")
...
ggsave(plot_es_h1_4, filename = "EA_GAUSS_ES_h14.pdf",
       width = 210,
       height = 90,
       units = "mm")
...
ggsave(plot_vs_h, filename = "EA_GAUSS_VS_h.pdf",
       width = 210,
       height = 200,
       units = "mm")
...
ggsave(plot_vs_h1_4, filename = "EA_GAUSS_VS_h14.pdf",
       width = 210,
       height = 90,
       units = "mm")
